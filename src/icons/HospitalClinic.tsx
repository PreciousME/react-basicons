...
const HospitalClinic: React.FC<IconConfig> = ({size=24, color='#000', weight=1.5}) => {
    return (
...
<path d="M12 7.5V12.5M9.5 10H14.5" stroke={`${color}`} strokeWidth={`${weight || 1.5}`} strokeLinecap="round" strokeLinejoin="round"/>
</svg>
